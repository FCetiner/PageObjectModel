...
public class C01_WebTableDinamikLocate {
    ...
    //2. method satir no ve data no girdigimde overdigim ddatayi yazdirsin
    //3. sutun no verdigimde bana tum sutunu yazdirsin
    ...
    public void hucreGetirTesti(){
        ...
        System.out.println("girdiginiz hucre element : "+hmcWebTablePage.hucreWebElementGetir(3, 5));
   Driver.closeDriver();
    }
    ...
    public void sutunYazdirTest(){
        ...
        hotelMyCampPage.girisYap();
        hmcWebTablePage=new HMCWebTablePage();
        //Web table da sutun yapisi yok bu yuzden her satira gidip 3. td alacagiz
